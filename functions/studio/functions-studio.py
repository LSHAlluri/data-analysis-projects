...
def reverse_characters(string2reverse):
    string2reverse_list=list(string2reverse)
    string2reverse_list.reverse()
    # reversed_string_with_commas = ','.join(string2reverse_list)
    # reversed_string = reversed_string_with_commas.replace(',','')
    # the above 2 statements are equal to the one statement below
    reversed_string = "".join(string2reverse_list)
    return reversed_string

test_string = "I love the smell of code in the morning."
...
# convert the parameter to a string, reverse the characters, then convert it back into a number. 
...
def reverse_characters(string2reverse):
    if isinstance(string2reverse,str):
        string2reverse_list=list(string2reverse)
        string2reverse_list.reverse()
        reversed_string_with_commas = ','.join(string2reverse_list)
        reversed_string = reversed_string_with_commas.replace(',','')
        return reversed_string
    elif isinstance(string2reverse,int) or isinstance(string2reverse,float):
        str_string2reverse=str(string2reverse)
        str_string2reverse_list=list(str_string2reverse)
        str_string2reverse_list.reverse()
        reversed_str_string2reverse = "".join(str_string2reverse_list)
        return reversed_str_string2reverse

test_num = 1234.67
print(reverse_characters(test_num))
...
def reversing(list_parameter):
    my_list=[]
    for element in list_parameter:  
        reversed = reverse_characters(element) 
        my_list.append(reversed)
    my_list.reverse()
    return my_list

print(reversing(list_test1))
